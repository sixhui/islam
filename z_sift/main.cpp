...
string path_image_save = "/home/liuxh/code/islam/z_sift/image_save/";

int main(int argc, char* argv[])
{
    /********************** 1、读入数据 **********************/
    cout << "1" << endl;
    Mat image_1 = imread("/home/liuxh/code/islam/z_sift/test_data/perspective_graf_1.ppm", -1);
    Mat image_2 = imread("/home/liuxh/code/islam/z_sift/test_data/perspective_graf_2.ppm", -1);
    imshow("1", image_1);
    imshow("2", image_2);
    waitKey(0);
